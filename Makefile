...
WEB_BRIDGE_CORE_SOURCES := $(ENGINE_SOURCE) $(LEARNED_ITERATION_SOURCE) $(ARTIFACT_INTEGRITY_SOURCE) $(LEARNED_PRIORITY_BILINEAR_ARTIFACT_SOURCE) src/selfplay_zero.cpp $(WEB_BRIDGE_SOURCE)
