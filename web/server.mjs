...
export const DECKS = Object.freeze([
  ...
  },
  {
    ...
    colors: ["black", "red"],
    deckList:
      "4 Juzam Djinn / 4 Sedge Troll / 4 Hypnotic Specter / 4 Su-Chi / 7 Lightning Bolt / 3 Shatter / Ancestral Recall / Dark Ritual / Demonic Tutor / 2 Disintegrate / Mind Twist / Time Walk / Wheel of Fortune / Black Lotus / Chaos Orb / Mox Jet / Mox Ruby / Mox Sapphire / Sol Ring / 7 Swamp / 4 Badlands / 3 Mishra's Factory / 2 City of Brass / 2 Volcanic Island / Library of Alexandria / Strip Mine / Underground Sea",
    cards: [
      { name: "Juzam Djinn", count: 4 },
      { name: "Sedge Troll", count: 4 },
      { name: "Hypnotic Specter", count: 4 },
      { name: "Su-Chi", count: 4 },
      { name: "Lightning Bolt", count: 7 },
      { name: "Shatter", count: 3 },
      { name: "Ancestral Recall", count: 1 },
      { name: "Dark Ritual", count: 1 },
      { name: "Demonic Tutor", count: 1 },
      ...
      { name: "Sol Ring", count: 1 },
      { name: "Swamp", count: 7 },
      { name: "Badlands", count: 4 },
      { name: "Mishra's Factory", count: 3 },
      { name: "City of Brass", count: 2 },
      { name: "Volcanic Island", count: 2 },
      { name: "Library of Alexandria", count: 1 },
      { name: "Strip Mine", count: 1 },
      { name: "Underground Sea", count: 1 },
    ],
...
function bridgeArguments(config, deckCatalog) {
  ...
  const args = [
    "--human-deck",
    humanCustomCards === null ? config.players[0].deckId : "uwr",
    "--opponent-deck",
  ...
  if (config.players[1].policyId === "spz") {
    // One champion for the whole six-deck era (the specialist /
    // generalist split ended when the metagame became the real decks).
    ...
    args.push(
      "--spz-artifact",
      path.resolve(SERVER_DIRECTORY, "../data/spz-champion.txt"),
    );
  }
  return args;
}
