...
// Runs one Human versus Handcrafted-bot game with the selected decks. The
// terminal opts into the human-only opponent-hand reveal for behavior
// inspection. The bot policy still receives no opponent hand identities, and
// neither library order is exposed.
