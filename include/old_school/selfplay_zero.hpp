...
inline constexpr std::size_t kSpzDeckCount = 11;
...
struct SpzPolicyConfig {
    ...
    // Per-world width of the rollout-score noise band inside which the
...
// 2 * kSpzDeckCount * kSpzDeckCount (98 with seven decks) is therefore
